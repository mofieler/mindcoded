  ...
  <div class="min-h-screen px-6 py-32">
    <div class="mx-auto max-w-2xl">
      ...
      <div v-if="confirmed" class="text-center">
        ...
        <h1 class="mb-4 text-3xl font-bold text-white">{{ t('optin.confirmed') }}</h1>
        <NuxtLink :to="localePath('/')" class="mt-8 inline-block text-sm text-white/50 underline hover:text-white transition-colors">
