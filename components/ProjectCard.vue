...
<template>
  <NuxtLink
    ...
    class="group block rounded-xl overflow-hidden border border-border bg-surface hover:border-accent transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/20"
  >
    <!-- Cover Image -->
