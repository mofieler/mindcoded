/** Visitor-supplied text is interpolated into these templates — escape it. */
...
export function confirmationEmailHtml(confirmUrl: string, locale: 'de' | 'en'): string {
  if (locale === 'de') {
    return `<!DOCTYPE html>
<html lang="de">
<head><meta charset="UTF-8"><meta name="color-scheme" content="light dark"><title>Bitte bestätigen Sie Ihre E-Mail-Adresse</title></head>
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#161616;border-radius:12px;padding:48px;border:1px solid #262626;">
        <tr><td>
          ...
          <h1 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#f5f5f5;line-height:1.2;">Bitte bestätigen Sie Ihre E-Mail-Adresse</h1>
          <p style="margin:0 0 32px;font-size:16px;color:#9ca3af;line-height:1.6;">Sie haben eine Kontaktanfrage über mindcoded.studio gesendet. Klicken Sie auf den Button, um Ihre E-Mail-Adresse zu bestätigen und die Anfrage abzuschließen.</p>
          <a href="${confirmUrl}" style="display:inline-block;padding:14px 32px;background:#2563eb;color:#fff;font-size:15px;font-weight:600;text-decoration:none;border-radius:8px;">E-Mail-Adresse bestätigen</a>
          <p style="margin:32px 0 0;font-size:13px;color:#6b7280;line-height:1.6;">Der Link ist 24 Stunden gültig.<br>Falls Sie keine Anfrage gesendet haben, können Sie diese Nachricht ignorieren.</p>
          <p style="margin:16px 0 0;font-size:12px;color:#4b5563;">Link funktioniert nicht? Kopieren Sie diesen URL:<br><span style="color:#6b7280;word-break:break-all;">${confirmUrl}</span></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#161616;border-radius:12px;padding:48px;border:1px solid #262626;">
        <tr><td>
          ...
          <p style="margin:0 0 32px;font-size:16px;color:#9ca3af;line-height:1.6;">You submitted a contact request on mindcoded.studio. Click the button below to confirm your email address and complete your request.</p>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0d0d0d;padding:48px 24px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#161616;border-radius:12px;padding:48px;border:1px solid #262626;">
        <tr><td>
          <p style="margin:0 0 8px;font-size:12px;letter-spacing:0.1em;text-transform:uppercase;color:#6b7280;">mindcoded</p>
          <h1 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#f5f5f5;line-height:1.2;">Vielen Dank. Ich melde mich in Kürze.</h1>
          <p style="margin:0 0 32px;font-size:16px;color:#9ca3af;line-height:1.6;">Ihre Kontaktanfrage (${email}) wurde bestätigt. Ich melde mich in Kürze bei Ihnen.</p>
          <p style="margin:0;font-size:14px;color:#6b7280;">Freundliche Grüße,<br><strong style="color:#e5e5e5;">Moritz, Mindcoded</strong></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0d0d0d;padding:48px 24px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#161616;border-radius:12px;padding:48px;border:1px solid #262626;">
        <tr><td>
          <p style="margin:0 0 8px;font-size:12px;letter-spacing:0.1em;text-transform:uppercase;color:#6b7280;">mindcoded</p>
          <h1 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#f5f5f5;line-height:1.2;">Thank you. I will be in touch shortly.</h1>
          <p style="margin:0 0 32px;font-size:16px;color:#9ca3af;line-height:1.6;">Your contact request (${email}) has been confirmed. I will get back to you shortly.</p>
          <p style="margin:0;font-size:14px;color:#6b7280;">Kind regards,<br><strong style="color:#e5e5e5;">Moritz, Mindcoded</strong></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#161616;border-radius:12px;padding:48px;border:1px solid #262626;">
        <tr><td>
          ...
          <h1 style="margin:0 0 32px;font-size:24px;font-weight:700;color:#f5f5f5;">📬 ${safeSubject}</h1>
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr><td style="padding:12px 0;border-bottom:1px solid #262626;">
              ...
              <p style="margin:4px 0 0;font-size:16px;color:#f5f5f5;font-weight:600;">${safeName}</p>
            </td></tr>
            <tr><td style="padding:12px 0;border-bottom:1px solid #262626;">
              <p style="margin:0;font-size:13px;color:#6b7280;text-transform:uppercase;letter-spacing:0.05em;">Email</p>
              <a href="mailto:${safeEmail}" style="margin:4px 0 0;font-size:16px;color:#2563eb;display:block;">${safeEmail}</a>
            </td></tr>
          </table>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0d0d0d;padding:48px 24px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#161616;border-radius:12px;padding:48px;border:1px solid #262626;">
        <tr><td>
          <p style="margin:0 0 8px;font-size:12px;letter-spacing:0.1em;text-transform:uppercase;color:#6b7280;">mindcoded</p>
          <h1 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#f5f5f5;line-height:1.2;">Vielen Dank für Ihre Nachricht, ${esc(name)}.</h1>
          <p style="margin:0 0 32px;font-size:16px;color:#9ca3af;line-height:1.6;">Ihre Anfrage ist bei mir angekommen. Ich antworte in der Regel innerhalb eines Werktags.</p>
          <p style="margin:0;font-size:14px;color:#6b7280;">Freundliche Grüße,<br><strong style="color:#e5e5e5;">Moritz, Mindcoded</strong></p>
        </td></tr>
      </table>
    </td></tr>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0d0d0d;padding:48px 24px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#161616;border-radius:12px;padding:48px;border:1px solid #262626;">
        <tr><td>
          <p style="margin:0 0 8px;font-size:12px;letter-spacing:0.1em;text-transform:uppercase;color:#6b7280;">mindcoded</p>
          <h1 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#f5f5f5;line-height:1.2;">Thank you for your message, ${esc(name)}.</h1>
          <p style="margin:0 0 32px;font-size:16px;color:#9ca3af;line-height:1.6;">Your message has been received. I usually reply within one working day.</p>
          <p style="margin:0;font-size:14px;color:#6b7280;">Kind regards,<br><strong style="color:#e5e5e5;">Moritz, Mindcoded</strong></p>
        </td></tr>
      </table>
    </td></tr>
